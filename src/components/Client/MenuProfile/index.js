  ...
  return user ? (
    <div className="col-lg-4 col-md-12 border-info-left">
      <div className="member-card">
        <div ref={tilt} className="rad-12 member-card-gold ">
          ...
          <div className="card-info-rank text-metal-gold fs-6">GOLD</div>
      ...
      <div className="pd-12">
        ...
        <div className="options-user user-active pe-cursor">
          <i className="fa-solid fa-clock-rotate-left mx-4 text-secondary"></i>{" "}
          Lịch sử mua hàng
        </div>
      </div>
    </div>
