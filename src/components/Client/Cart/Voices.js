  ...
  return (
    <>
      ...
      <div className="py-3 d-flex justify-content-between align-items-center bd-bottom">
        ...
        <span id="price_charge_show">
          {Number(priceShip).toLocaleString("vi-VN", {
            style: "currency",
            currency: "VND",
          })}
        </span>
      ...
      <div className="py-3 d-flex justify-content-between align-items-center">
        <div
          id="btn_show_modal_KM"
          onClick={() => dispatch(modalSlice.actions.setCoupon(true))}
          className="color-primary pe-cursor"
        >
          Khuyến mãi
        </div>
        <div id="content-coupon">
          {coupon === "" || coupon === null
            ? ""
            : `${coupon}(${priceCoupon.toLocaleString("vi-VN", {
                style: "currency",
                currency: "VND",
              })})`}
        </div>
