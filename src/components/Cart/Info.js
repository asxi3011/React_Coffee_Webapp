  ...
  useEffect(() => {
    ...
    return(
        ...
        <div className="d-flex align-items-center justify-content-between py-3 header">
            ...
            <span className="fw-bold fs-5 pe-cursor">
              Lấy hàng
          ...
          <div>
              <div className="d-flex align-items-center justify-content-between ">
                    ...
                    <input id="inputAddress" className={isAcceptAddress ? "form-control input-text-address" : "form-control input-text-address border-1 text-danger border-danger"} type="text" value={address} onChange={(e)=>{dispatch(cartSlice.actions.setAddress(e.target.value))}} onBlur={handleAddress} name="addressCus" placeholder="Địa chỉ" required />
